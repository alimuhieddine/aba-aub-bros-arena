    ...
    <article class="card">
      <div class="row">
        <div>
          ...
          ${a.proof_path ? `<button class="small-btn" type="button" onclick="openActivityProof('${a.id}')">Open ${escapeHtml(proofLabel)}</button>` : `<div class="meta">Proof: not attached</div>`}
